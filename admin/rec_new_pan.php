                                ...
                                if ($fetched_new_pan && $fetched_new_pan->num_rows > 0) {
                                    while ($new_pan_row = $fetched_new_pan->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <span class="text-success" style="font-weight: 900;"><?php echo $new_pan_row['new_status']; ?></span> 
                                                <form action="../forms_datas.php" method="post">
                                                    <input type="hidden" name="new_pan_status_update_id" value="<?php echo $new_pan_row['new_pan_id']; ?>">
                                                    ...
                                                    <br/>
                                                    <input type="submit" name="status_new_pan_submit" class="mt-1 btn btn-outline-success btn-sm rounded-0">
                                                </form>
                                            </td>
                                            ...
                                            <td>
                                                <div class="offcanvas offcanvas-start" id="demo">
                                                    ...
                                                    <div class="offcanvas-body">
                                                        ...
                                                        <img src="../<?php echo $new_pan_row['new_profile_picture']; ?>"
                                                            alt="Profile Photo" class="img-fluid my-2 rounded-2"
                                                            style="width: 100px; height: 100px;"><br />

                                                        <span style="font-weight: 900;">Name:</span>
                                                        <span><?php echo $new_pan_row['new_call_name']; ?></span><br />
                                                        <span style="font-weight: 900;">Mobile: </span>
                                                        <span><?php echo $new_pan_row['new_mobile_number']; ?></span><br />
                                                        <span style="font-weight: 900;">Aadhar:</span>
                                                        <span><?php echo $new_pan_row['new_aadhaar_number']; ?> </span>

                                                        <form action="../forms_datas.php" method="post">
                                                            <input type="hidden" name="delete_new_pan_id"
                                                                value="<?php echo $new_pan_row['new_pan_id']; ?>">
                                                            <input type="submit" name="delete_new_pan"
