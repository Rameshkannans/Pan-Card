...
class Database
{
    ...
    public function insert_new_pan_db($new_call_name, $new_aadharNumber, $new_mobileNumber, $new_email, $new_pan_dob, $new_choose_fm, $new_fm_profile_folder, $new_fm_new_signature_folder, $new_gender, $new_fatherName, $new_aadhaar_doc_folder, $new_profile_folder, $new_signature_folder)
    {
        $newPanCard = "INSERT INTO new_pan (new_call_name,new_aadhaar_number,new_mobile_number,new_email,new_pan_dob,new_parent,new_fm_profile_picture,new_fm_signature_picture,new_gender,new_pan_father,new_aadhaar_doc,new_profile_picture,new_signature) 
                      VALUES ('" . $new_call_name . "','" . $new_aadharNumber . "', '" . $new_mobileNumber . "','" . $new_email . "','" . $new_pan_dob . "','" . $new_choose_fm . "','" . $new_fm_profile_folder . "','" . $new_fm_new_signature_folder . "', '" . $new_gender . "', '" . $new_fatherName . "', '" . $new_aadhaar_doc_folder . "', '" . $new_profile_folder . "','$new_signature_folder')";
    ...
    public function insert_update_pan_db(
        ...
        $updatePanCard = "INSERT INTO update_pan (update_oldpan_doc,update_call_name,update_aadhaar_number,update_mobile_number,update_email,update_aadhaar_doc,update_profile_picture,
        ...
        update_dob,update_dob_proof) 
                      VALUES ('" . $update_oldpan_doc_folder . "','" . $update_call_name . "', '" . $update_aadharNumber . "', '" . $update_mobileNumber . "','" . $update_email . "', '" . $update_aadhaar_doc_folder . "', '" . $update_profile_folder . "', '" . $update_signature_folder . "','" . $update_firstName . "'
                      ,'" . $update_middleName . "','" . $update_lastName . "','" . $update_nameproof_doc_folder . "','" . $update_fatherName . "','" . $update_fathernameproof_doc_folder . "'
                      ,'" . $update_dob . "','" . $update_dobproof_doc_folder . "')";
    ...
    public function search_user_status_new($status_search_mobile)
    {
        $select_user_status_new = "SELECT * FROM new_pan WHERE new_mobile_number = $status_search_mobile";
    ...
    public function search_user_status_update($status_search_mobile)
    {
        $select_user_status_update = "SELECT * FROM update_pan WHERE update_mobile_number = $status_search_mobile";
    ...
    public function moveDataToDeletedNewPan()
    {
        $sql = "INSERT INTO deleted_new_pan ( deleted_new_created_at, deleted_old_new_pan_id,deleted_new_call_name, deleted_new_aadhaar_number, deleted_new_mobile_number, deleted_new_email,deleted_new_pan_dob,deleted_new_parent,deleted_new_fm_profile_picture,deleted_new_fm_signature_picture,deleted_new_gender, deleted_new_pan_father, deleted_new_aadhaar_doc, deleted_new_profile_picture, deleted_new_signature)
            SELECT  new_pan_created_at,new_pan_id,new_call_name, new_aadhaar_number, new_mobile_number, new_email, new_pan_dob,new_parent,new_fm_profile_picture,new_fm_signature_picture,new_gender, new_pan_father, new_aadhaar_doc, new_profile_picture, new_signature
            FROM new_pan";
        $result = $this->conn->query($sql);
    }
