...
if (isset($_POST['user_status'])) {
    $status_search_mobile = $_POST['status_search_mobile'];
    $querys = new Database();
    $sel_user_status_new = $querys->search_user_status_new($status_search_mobile);
    $sel_user_status_update = $querys->search_user_status_update($status_search_mobile);
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-user text-danger' style="font-size: 25px;"></i><span
                ...
                <div class="nav_list">
                    ...
                    </a> <a href="#" class="nav_link">  <i class='bx bxs-contact' style="font-size: 20px;"></i><span class="nav_name">User
                            Detials</span> </a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="card-body text-center ">
                        <form class=" d-flex justify-content-center" action="" method="post"
                            ...
                            <input class="form-control me-2 rounded-0 w-50"
                                oninput="this.value = this.value.replace(/[^6789\d]/g, '');" type="text"
                                name="status_search_mobile" pattern="[6789]\d{9}"
                                title="Please enter a 10-digit number starting with 6, 7, 8, or 9" maxlength="10"
                                type="text" placeholder="mobile number" required>
                            <input type="submit" class="btn btn-primary rounded-0" value="Submit" name="user_status">
                        </form>
                        ...
                        <?php if (isset($sel_user_status_new['new_pan_id']) || isset($sel_user_status_update['update_pan_id'])) { ?>
                            <div class="row">
                                <div class="col-md-6 col-sm-12 text-start p-5">
                                    <p><span class="fw-bold">ID : </span>
                                        <?php
                                        if (isset($sel_user_status_new['new_pan_id']) || isset($sel_user_status_update['update_pan_id'])) {
                                            echo isset($sel_user_status_new['new_pan_id']) ? $sel_user_status_new['new_pan_id'] : $sel_user_status_update['update_pan_id'];
                                        }
                                        ?>
                                    </p>
